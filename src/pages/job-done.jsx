...
import '../styles/SalesReport.css'; // Using the base layout classes from SalesReport
import '../styles/job-done.css';
    ...
    return (
        <div className="jd-page">
            <div className="jd-header">
                ...
                <h1 className="jd-title">Service List</h1>
                        ...
                        <div className="jd-modal-body">
                            ...
                            <div className="jd-grid-2">
                                ...
                                <div className="jd-box jd-filter-box">
                                    ...
                                    {!phone && <i className="fa-solid fa-xmark jd-clear-icon" style={{ pointerEvents: 'none', color: '#cbd5e1' }}></i>}
                                </div>
                                ...
                                <div className="jd-box jd-filter-box">
                                    ...
                                    {!customerName && <i className="fa-solid fa-xmark jd-clear-icon" style={{ pointerEvents: 'none', color: '#cbd5e1' }}></i>}
                                </div>
                                ...
                                <div className="jd-box jd-filter-box">
                                    ...
                                    {!imei && <i className="fa-solid fa-xmark jd-clear-icon" style={{ pointerEvents: 'none', color: '#cbd5e1' }}></i>}
                                </div>
                                ...
                                <div className="jd-box jd-filter-box">
                                    ...
                                    {!billNumber && <i className="fa-solid fa-xmark jd-clear-icon" style={{ pointerEvents: 'none', color: '#cbd5e1' }}></i>}
                                </div>
                            </div>
                        </div>
